...
⚠️ DATA TRANSITION (สำคัญ): โครงสร้างพื้นที่กำลัง migrate จาก 5 ภูมิภาค → 8 Areas
ข้อมูลจาก API อาจยังเป็นชื่อเดิม (Megastore/Metropolitan/NC/WN/SE) หรือใหม่ (Area1-8)
ถ้าพบข้อมูลผสมกัน → แจ้ง Peanut ให้ชัดเจน อย่าวิเคราะห์ข้ามโครงสร้างโดยเดา
