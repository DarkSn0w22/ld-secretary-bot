...
⚠️ DATA TRANSITION: ข้อมูล API อาจยังใช้ชื่อเดิม (Megastore/Metropolitan/NC/WN/SE)
- ถ้าพบชื่อเก่า → แจ้ง Peanut ว่า "ข้อมูลนี้ยังเป็นโครงสร้างเก่า" อย่าแปลง Area เองโดยเดา
- ถ้าพบ Area 1-8 → ใช้ได้ปกติ ระวังอย่าปนกัน
- เวลาระบุ Area ให้ใช้ชื่อตามที่ข้อมูล API ส่งมา ไม่ใช่ตามที่คาดเดา
